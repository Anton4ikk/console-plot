...
console.log('\n=== CJS Test: Basic Functionality - Default MaxWidth Limit (30) ===');
...
console.log('\n=== CJS Test: Basic Functionality - Long Label Truncation ===');
...
console.log('\n=== CJS Test: Basic Functionality - Custom Pointer Character ===');
const yData6 = [1, 2, 3];
const xData6 = ['A', 'B', 'C'];
plotGraph({ yData: yData6, xData: xData6, pointer: '#' });

console.log('\n=== CJS Test: Basic Functionality - Custom MaxHeight Parameter ===');
const yData7 = [1, 2, 3, 4, 5];
const xData7 = ['A', 'B', 'C', 'D', 'E'];
plotGraph({ yData: yData7, xData: xData7, maxHeight: 10 });

console.log('\n=== CJS Test: MaxWidth Downsampling - No Downsampling Required ===');
plotGraph({
  yData: [1, 3, 2, 4],
  xData: ['A', 'B', 'C', 'D'],
  maxWidth: 10,
...
console.log('\n=== CJS Test: MaxWidth Downsampling - 20 Points to 5 Points ===');
...
console.log('\n=== CJS Test: MaxWidth Downsampling - Extreme 100 Points to 3 Points ===');
